...
async function ensureEmbeddedPostgresConnection(
  ...
  const preferredAdminConnectionString = `postgres://zeroinc:zeroinc@127.0.0.1:${preferredPort}/postgres`;
  ...
  if (!runningPid && existsSync(pgVersionFile)) {
    try {
      ...
      await ensurePostgresDatabase(preferredAdminConnectionString, "zeroinc");
      process.emitWarning(
      ...
      return {
        connectionString: `postgres://zeroinc:zeroinc@127.0.0.1:${preferredPort}/zeroinc`,
  ...
  if (runningPid) {
    ...
    const adminConnectionString = `postgres://zeroinc:zeroinc@127.0.0.1:${port}/postgres`;
    await ensurePostgresDatabase(adminConnectionString, "zeroinc");
    return {
      connectionString: `postgres://zeroinc:zeroinc@127.0.0.1:${port}/zeroinc`,
  ...
  const adminConnectionString = `postgres://zeroinc:zeroinc@127.0.0.1:${selectedPort}/postgres`;
  await ensurePostgresDatabase(adminConnectionString, "zeroinc");

  return {
    connectionString: `postgres://zeroinc:zeroinc@127.0.0.1:${selectedPort}/zeroinc`,
