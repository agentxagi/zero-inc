...
import type { PluginCategory, PluginStatus, ZeroIncPluginManifestV1 } from "@zeroinc/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<ZeroIncPluginManifestV1>().notNull(),
