...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within ZeroIncPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the ZeroInc host.
 *
...
export interface ZeroIncPluginManifestV1 {
   ...
   */
  minimumZeroIncVersion?: PluginMinimumHostVersion;
