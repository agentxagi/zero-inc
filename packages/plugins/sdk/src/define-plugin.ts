/**
 * `definePlugin` — the top-level helper for authoring a ZeroInc plugin.
 *
...
// ---------------------------------------------------------------------------
// ZeroIncPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface ZeroIncPlugin {
 ...
 * @returns A sealed `ZeroIncPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@zeroinc/plugin-sdk";
