...
import type { ZeroIncPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@zeroinc/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: ZeroIncPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@zeroinc/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
