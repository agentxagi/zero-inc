/**
 * `@zeroinc/plugin-sdk/ui` — ZeroInc plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@zeroinc/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@zeroinc/plugin-sdk/ui";
 *
