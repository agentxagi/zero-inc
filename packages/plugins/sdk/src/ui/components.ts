 ...
 *
 * These components are exported from `@zeroinc/plugin-sdk/ui` and are
 ...
 *
 * @see PLUGIN_SPEC.md §19.6 — Shared Components In `@zeroinc/plugin-sdk/ui`
 */
...
function createSdkUiComponent<TProps>(name: string): React.ComponentType<TProps> {
  return function ZeroIncSdkUiComponent(props: TProps) {
