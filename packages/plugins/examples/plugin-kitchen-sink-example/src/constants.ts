import type { PluginLauncherRegistration } from "@zeroinc/plugin-sdk";

export const PLUGIN_ID = "zeroinc-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".zeroinc-kitchen-sink-demo.txt",
} as const;
