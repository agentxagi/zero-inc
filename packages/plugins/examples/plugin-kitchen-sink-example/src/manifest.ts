...
const manifest: ZeroIncPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current ZeroInc plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "ZeroInc",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the ZeroInc domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
