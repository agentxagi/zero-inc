...
import type { AdapterEnvironmentTestResult } from "@zeroinc/shared";
...
} from "@zeroinc/adapter-codex-local";
import { DEFAULT_CURSOR_LOCAL_MODEL } from "@zeroinc/adapter-cursor-local";
import { DEFAULT_GEMINI_LOCAL_MODEL } from "@zeroinc/adapter-gemini-local";
...
https://github.com/agentxagi/zero-inc/blob/main/default/ceo/AGENTS.md
                    ...
                    <div className="space-y-3">
                      <div>
                        <div className="flex items-center gap-1.5 mb-1">
                          ...
                          <HintIcon text="ZeroInc works best if you create a new folder for your agents to keep their memories and stay organized. Create a new folder and put the path here." />
                        </div>
