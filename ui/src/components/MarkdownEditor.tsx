...
import { buildProjectMentionHref, parseProjectMentionHref } from "@zeroinc/shared";
...
export const MarkdownEditor = forwardRef<MarkdownEditorRef, MarkdownEditorProps>(function MarkdownEditor({
    ...
    for (const node of links) {
      ...
      if (!parsed) {
        if (link.dataset.projectMention === "true") {
          ...
          link.classList.remove("zeroinc-project-mention-chip");
      ...
      link.classList.add("zeroinc-project-mention-chip");
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative zeroinc-mdxeditor-scope",
    ...
    >
      <MDXEditor
        ...
        onBlur={() => onBlur?.()}
        className={cn("zeroinc-mdxeditor", !bordered && "zeroinc-mdxeditor--borderless")}
        contentEditableClassName={cn(
          "zeroinc-mdxeditor-content focus:outline-none [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:list-item",
          contentClassName,
        )}
        plugins={plugins}
      />
