export const queryKeys = {
  ...
  dashboardProductCouncil: (companyId: string) => ["dashboard", companyId, "product-council"] as const,
  dashboardHumanQueue: (companyId: string) => ["dashboard", companyId, "human-queue"] as const,
