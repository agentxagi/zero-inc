 ...
 *
 * This is placed on `globalThis.__zeroincPluginBridge__` and consumed by
...
declare global {
  ...
  var __zeroincPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__zeroincPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__zeroincPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
