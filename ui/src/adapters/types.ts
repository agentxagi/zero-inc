...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@zeroinc/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@zeroinc/adapter-utils").TranscriptEntry[];
