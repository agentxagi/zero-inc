...
Low-level reference for how ZeroInc packages are prepared and published to npm.
...
ZeroInc no longer uses release branches or Changesets for publishing.

## Why the CLI needs special packaging

The CLI package, `zeroinc`, imports code from workspace packages such as:
...
ZeroInc uses calendar versions:
