...
This document covers the GitHub and npm setup required for the current ZeroInc release model:
...
Do this for every public package that ZeroInc publishes.
...
3. add a trusted publisher for the GitHub repository `zeroinc/zeroinc`
...
2. revoke any personal automation token that used to publish ZeroInc
