...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.zeroinc/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.zeroinc/instances/default/data/storage` (`local_disk`)
...
- exactly one JSON entrypoint: `zeroinc.manifest.json`
