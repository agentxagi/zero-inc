...
- installed adapter list for this ZeroInc instance
...
## 8. New Skill: `zeroinc-create-agent`

Create new skill directory:

- `skills/zeroinc-create-agent/SKILL.md`
- `skills/zeroinc-create-agent/references/api-reference.md`
...
Also update `skills/zeroinc/SKILL.md` to reference this skill for hiring workflows.
...
- `zeroinc-create-agent` skill + docs updates
