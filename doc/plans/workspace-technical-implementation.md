...
This document translates [workspace-product-model-and-work-product.md](/Users/dotta/zeroinc-subissues/doc/plans/workspace-product-model-and-work-product.md) into an implementation-ready engineering plan.
...
- `local`
  - ZeroInc may create host-local worktrees, processes, and paths
- `cloud`
  - ZeroInc should assume no durable host-local execution workspace management
...
- `provider text not null`
  - `zeroinc | github | vercel | s3 | custom`
