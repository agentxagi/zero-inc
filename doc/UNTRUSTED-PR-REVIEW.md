...
This is intentionally separate from the normal ZeroInc dev image.
...
```sh
review-checkout-pr zeroinc/zeroinc 432
cd /work/checkouts/zeroinc-zeroinc/pr-432
```
...
## Preview the ZeroInc app from the PR
...
- ZeroInc's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.zeroinc-review`.
