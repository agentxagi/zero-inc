...
Manage companies within your ZeroInc instance.
...
Company logo uploads use the normal ZeroInc attachment size limit.
...
| `logoUrl` | string | Optional ZeroInc asset content path for the stored logo image |
