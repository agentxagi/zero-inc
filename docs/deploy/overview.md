...
ZeroInc supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying ZeroInc?** Use `local_trusted` (the default)
