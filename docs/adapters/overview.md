...
summary: What adapters are and how they connect agents to ZeroInc
---

Adapters are the bridge between ZeroInc's orchestration layer and agent runtimes. Each adapter knows how to invoke a specific type of AI agent and capture its results.

## How Adapters Work

When a heartbeat fires, ZeroInc:
...
packages/adapters/<name>/
  src/
    ...
    cli/
      format-event.ts   # Terminal output for `zeroinc run --watch`
```
