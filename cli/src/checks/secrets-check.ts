...
export function secretsCheck(config: ZeroIncConfig, configPath?: string): CheckResult {
  ...
  if (provider !== "local_encrypted") {
    return {
      ...
      canRepair: false,
      repairHint: "Run `zeroinc configure --section secrets` and set provider to local_encrypted",
    };
  }
