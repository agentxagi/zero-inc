...
import { companySkills } from "@zeroinc/db";
import { readPaperclipSkillSyncPreference, writePaperclipSkillSyncPreference } from "@zeroinc/adapter-utils/server-utils";
import type { PaperclipSkillEntry } from "@zeroinc/adapter-utils/server-utils";
import type {
  CompanySkill,
...
import { normalizeAgentUrlKey } from "@zeroinc/shared";
import { findServerAdapter } from "../adapters/index.js";
import { resolveZeroIncInstanceRoot } from "../home-paths.js";
...
function resolveManagedSkillsRoot(companyId: string) {
  return path.resolve(resolveZeroIncInstanceRoot(), "skills", companyId);
}
