/**
 * PluginEventBus — typed in-process event bus for the ZeroInc plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@zeroinc/shared";
import type { PluginEvent, EventFilter } from "@zeroinc/plugin-sdk";
