...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@zeroinc/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: ZeroIncPluginManifestV1, pluginDbId?: string): void;
