...
import { createHostClientHandlers } from "@zeroinc/plugin-sdk";
...
export async function createApp(
  ...
  app.get("/api/auth/get-session", (req, res) => {
    ...
    res.json({
      session: {
        id: `zeroinc:${req.actor.source}:${req.actor.userId}`,
  ...
  if (opts.uiMode === "static") {
    ...
    if (uiDist) {
      ...
      console.warn("[zeroinc] UI dist not found; running in API-only mode");
    }
  }
