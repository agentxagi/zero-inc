...
import { agents as agentsTable, companies, heartbeatRuns } from "@zeroinc/db";
...
import { ensureOpenCodeModelConfiguredAndAvailable } from "@zeroinc/adapter-opencode-local/server";
import {
